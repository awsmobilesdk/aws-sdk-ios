...
@class AWSConnectAuthenticationProfile;
@class AWSConnectAuthenticationProfileSummary;
...
@class AWSConnectDescribeAuthenticationProfileRequest;
@class AWSConnectDescribeAuthenticationProfileResponse;
...
@class AWSConnectListAuthenticationProfilesRequest;
@class AWSConnectListAuthenticationProfilesResponse;
...
@class AWSConnectUpdateAuthenticationProfileRequest;
 ...
 */
@interface AWSConnectAuthenticationProfile : AWSModel
 ...
 */
@property (nonatomic, strong) NSArray<NSString *> * _Nullable allowedIps;
 ...
 */
@property (nonatomic, strong) NSArray<NSString *> * _Nullable blockedIps;
 ...
 */
@property (nonatomic, strong) NSNumber * _Nullable periodicSessionDuration;

@end

/**
 <p>This API is in preview release for Amazon Connect and is subject to change. To request access to this API, contact Amazon Web Services Support.</p><p>A summary of a given authentication profile.</p>
 */
@interface AWSConnectAuthenticationProfileSummary : AWSModel
 ...
 */
@interface AWSConnectDescribeAuthenticationProfileRequest : AWSRequest


/**
 <p>A unique identifier for the authentication profile. </p>
 */
@property (nonatomic, strong) NSString * _Nullable authenticationProfileId;
 ...
 */
@interface AWSConnectDescribeAuthenticationProfileResponse : AWSModel


/**
 <p>The authentication profile object being described.</p>
 */
@property (nonatomic, strong) AWSConnectAuthenticationProfile * _Nullable authenticationProfile;
 ...
 */
@interface AWSConnectListAuthenticationProfilesRequest : AWSRequest
 ...
 */
@interface AWSConnectListAuthenticationProfilesResponse : AWSModel


/**
 <p>A summary of a given authentication profile.</p>
 */
@property (nonatomic, strong) NSArray<AWSConnectAuthenticationProfileSummary *> * _Nullable authenticationProfileSummaryList;
 ...
 */
@interface AWSConnectUpdateAuthenticationProfileRequest : AWSRequest
